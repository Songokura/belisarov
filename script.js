...
(function () {
  ...
  var KK = {
    ...
    "hero.h1a": "15 жыл мен процестің арғы жағында жұмыс істедім.",
    "hero.h1b": "Енді&nbsp;— сіздің жағыңыздамын.",
    "hero.sub": "ІІО тергеушісі, Экономикалық тергеу қызметі, прокуратура&nbsp;— мемлекеттік машинаның істі қалай жүргізетінін іштен білемін. Бүгін бұл тәжірибе сізге қызмет етеді: сотта, мемлекеттік органдармен дауларда және күрделі келіссөздерде.",
    ...
    "cluster.b": "Бизнеске және мемлекетпен жұмыс",
    ...
    "svc.sudy.l4": "келіссөздер, сотқа дейінгі реттеу, татуласу келісімдері",
    ...
    "svc.vzyskanie.l4": "жеке сот орындаушыларының әрекеттеріне шағымдану, ЖСО палатасына шағымдар",

    "svc.dogovory.t": "Шарттық және кәсіпкерлік даулар",
    "svc.dogovory.l1": "жеткізу, мердігерлік, жалдау, қызмет көрсету бойынша даулар",
    "svc.dogovory.l2": "шарттарды талдау және дайындау, талаптарды түзету",
    ...
    "svc.biznes.l4": "корпоративтік мәселелер, ЖК және ЖШС тіркеу және тарату",
    ...
    "svc.poterpevshie.l1": "қылмыс туралы арыз және оны СДТБТ-да (ЕРДР) тіркеу",
    ...
    "proc.t2": "Талдау",
    "proc.p2": "Құжаттар мен практиканы зерделеймін, істің болашағын бағалаймын және құнын атаймын&nbsp;— жұмыс басталғанға дейін.",
    "proc.t3": "Позиция",
    ...
    "honest.c": "Мен «кез келген істі жеңеміз» деп уәде бермеймін&nbsp;— мүмкіндіктерді адал бағалап, нақты көмектесе алатын істерге ғана кірісемін.",

    "rev.label": "Пікірлер",
    "rev.h2": "Клиенттер не дейді",
    "rev.cap": "2ГИС-тегі рейтинг",
    "rev.btn2gis": "2ГИС-тегі пікірлер",
    "rev.btngoogle": "Google-дағы пікірлер",
    ...
    "form.sub": "Жағдайды сипаттаңыз&nbsp;— жауап беріп, қалай көмектесе алатынымды айтамын. Форма дайын хабарламамен WhatsApp-ты ашады, деректер еш жерде сақталмайды.",
    "form.name": "Есіміңіз",
    "form.nameph": "Сізге қалай жүгінейін",
    "form.tel": "Телефон",
    "form.msg": "Жағдай туралы қысқаша",
    "form.msgph": "Мысалы: мердігер шарт бойынша аванс қайтармады…",
    "form.send": "WhatsApp-қа жіберу",
    "form.donet": "Рақмет!",
    "form.donep": "Хабарлама құрастырылып, WhatsApp-та ашылды. Терезе ашылмаса&nbsp;— жай ғана қоңырау шалыңыз: +7&nbsp;778&nbsp;359&nbsp;78&nbsp;78.",
