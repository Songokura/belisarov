...
(function () {
  ...
  var META = {
    ru: {
      title: "Талгатжан Белисаров — юридический консультант в Костанае. Судебные и сложные споры",
    ...
    kk: {
      title: "Талгатжан Белисаров — Қостанайдағы заң консультанты. Сот даулары және күрделі даулар",
  ...
  var KK = {
    ...
    "marquee": "сот даулары&ensp;·&ensp;берешекті өндіріп алу&ensp;·&ensp;салықтық тексерулер&ensp;·&ensp;мемлекеттік органдардың актілері&ensp;·&ensp;мемлекеттік сатып алу&ensp;·&ensp;құрылыс мердігерлігі&ensp;·&ensp;жер даулары&ensp;·&ensp;жер қойнауын пайдалану&ensp;·&ensp;мүлікті бөлу&ensp;·&ensp;жәбірленушілерді қорғау&ensp;·&ensp;құқықтық талдау&ensp;·&ensp;",
    ...
    "svc.gosorgany.t": "Мемлекеттік органдардың актілеріне шағымдану",
    "svc.gosorgany.l1": "заңсыз қаулылар мен нұсқамаларға шағымдар",
    "svc.gosorgany.l2": "мемлекеттік органдардың шешімдерін даулау",
    "svc.gosorgany.l3": "прокуратураға, жоғары тұрған органға, сотқа өтініштер",
    "svc.gosorgany.l4": "әкімшілік рәсімдер мен шағымдану мерзімдерін құқықтық талдау",
    ...
    "svc.konsultacii.l1": "бір реттік консультация&nbsp;— 10&nbsp;000&nbsp;₸-ден бастап",
    "svc.konsultacii.l1b": "құжаттарды құқықтық талдау және істің болашағын бағалау",
